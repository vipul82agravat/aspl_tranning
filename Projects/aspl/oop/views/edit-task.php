...
<!--         <h3>Insert Data In Databse using PHP OOPS Concept</h3> -->
  ...
  <tr>
    ...
    <td width="74%"><input type="text" name="task_names" value="<?php echo $row['task_names'] ?>" class="form-control" required /></td>
  </tr>
  <tr>
    <th width="26%" height="60" scope="row">Number Task :</th>
    <td width="74%"><input type="Number" name="number_task" value="<?php echo $row['number_task'] ?>" class="form-control" required /></td>
  </tr>

   <tr>
    <th height="60" scope="row">Task Start Date :</th>
    <td><input type="date" name="task_start_date" value="<?php echo $row['task_start_date'] ?>" class="form-control" required /></td>
  </tr>
   <tr>
    <th height="60" scope="row">Task End Date :</th>
    <td><input type="date" name="task_end_date" value="<?php echo $row['task_end_date'] ?>" class="form-control" required /></td>
   </tr>
    <tr>
    <th height="60" scope="row">Task Start Time :</th>
    <td><input type="datetime-local" name="task_start_time" value="<?php echo $row['task_start_time'] ?>" class="form-control"  /></td>
  </tr>
   <tr>
    <th height="60" scope="row">Task End Time :</th>
    <td><input type="datetime-local" name="task_end_time" value="<?php echo $row['task_end_time'] ?>" class="form-control"  /></td>
   </tr>
  <tr>
    <th width="26%" height="60" scope="row">Complated Task :</th>
    <td width="74%"><input type="Number" name="complated_task" value="<?php echo $row['complated_task'] ?>" class="form-control" required /></td>
  </tr>
   <tr>
  ...
  <tr>
    ...
    <td><textarea name="task_description" class="form-control"><?php echo $row['task_description'] ?>
	</textarea></td>
  </tr>
<!--  <tr>
